...
<div class="bd-auth-logos d-sm-flex text-center bg-light rounded-3 overflow-hidden w-100 mb-3">
...
<div class="bd-auth-logos d-sm-flex text-center border rounded-3 overflow-hidden w-100 mb-3">
  <div class="bd-brand-item w-100 px-2 py-5">
